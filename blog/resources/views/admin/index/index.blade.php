...
<frameset rows="100,*" cols="*" scrolling="No" framespacing="0"
    ...
    <frame src="http://www.laravel.com/admin/header"
    ...
    <!-- 引用左边和主体部分 --> <frameset rows="100*" cols="220,*" scrolling="No"
        ...
        <frame src="http://www.laravel.com/admin/left" name="leftmenu" id="mainFrame" title="mainFrame">

        <frame src="http://www.laravel.com/admin/main" name="main" scrolling="yes" noresize="noresize"
