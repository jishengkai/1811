    ...
    <div class="page ">
        ...
        <div class="banneradd bor">
            ...
            <div class="baBody">
                ...
                <div class="bbD">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;分类名称：
                    <input type="text" name="cate_name" class="input3" id="cate_name" value="{{$res->cate_name}}" />
                </div>
                <div class="bbD">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;所属分类：
                ...
                <div class="bbD">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;关&nbsp;键&nbsp;词：
                    <input type="text" name="keywords" class="input3" id="keywords" value="{{$res->keywords}}" />
                </div>
                <div class="bbD">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;分类简介：
                    <div class="btext2">
                        <textarea name="desc"  id="desc" class="text2">{{$res->cate_id}}</textarea>
                    </div>
                </div>
                <div class="bbD">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;是否推荐：
                    <label><input type="radio" class="is_status" name="is_status" value="是" @if($res->is_status=='是')checked @endif/>&nbsp;是</label>
                    <label><input type="radio" class="is_status" name="is_status" value="否" @if($res->is_status=='否')checked @endif/>&nbsp;否</label>
                </div>
                <div class="bbD">
                    <p class="bbDP">
                        <button class="btn_ok btn_yes" href="category/update">修改</button>
